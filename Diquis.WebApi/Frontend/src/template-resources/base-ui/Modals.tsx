    ...
    <Card>
      <Card.Body>
        ...
        <Modal show={isOpen} onHide={toggleModal} size="sm">
          <div className={clsx('modal-filled', 'bg-' + className)}>
      ...
      <Card.Body>
        ...
        <Modal show={isOpen} onHide={toggleModal}>
          <Modal.Header
            onHide={toggleModal}
            closeButton
            className={clsx('modal-colored-header', 'bg-' + className)}
          >
      ...
      <Card.Body>
        ...
        <Modal show={isOpen} onHide={toggleModal}>
          <Modal.Header
            onHide={toggleModal}
            closeButton
            className={clsx('modal-filled', 'bg-' + className)}
          >
            <h4 className="modal-title text-light">{className} Filled Modal</h4>
          </Modal.Header>
          <Modal.Body
            className={clsx('modal-filled', 'bg-' + className, 'text-light')}
          >
            <p>
              Cras mattis consectetur purus sit amet fermentum. Cras justo odio,
              dapibus ac facilisis in, egestas eget quam. Morbi leo risus, porta
          ...
          <Modal.Footer className={clsx('modal-filled', 'bg-' + className)}>
            <Button variant="light" onClick={toggleModal}>
              Close
            </Button>
