...
import { extendedColorVariants } from 'constants/color-variants';
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted mb-4">
          You can go for growing spinner as well. While it doesn’t technically
    ...
    <Card>
      <Card.Body>
        ...
        {extendedColorVariants.map((color, index) => {
          return (
            <Spinner key={index.toString()} className="m-2" color={color} />
          );
        })}
