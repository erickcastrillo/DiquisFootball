    ...
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">
          A progressBar bar can be used to show a user how far along he/she is
          in a process.
        </p>
    ...
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">
          ...
          <code>ProgressBar</code>, so if you change that value the inner{' '}
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">
          Add <code>striped</code> to any <code>ProgressBar</code> to apply a
          stripe via CSS gradient over the progressBar bar’s background color.
        </p>
    ...
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">
          ...
          to
          <code>ProgressBar</code> to animate the stripes right to left via CSS3
          animations.
        </p>
