...
const DefaultPagination = () => {
  ...
  for (let number = 1; number <= 5; number++) {
    items.push(
      <Pagination.Item key={number.toString()}>{number}</Pagination.Item>
    );
  }
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">
          PageItem are customizable for different circumstances. Use{' '}
          <code>disabled</code>
          {'  '}
          prop for links that appear un-clickable and <code>active</code> prop
    ...
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">
          ...
          buttons, as well as an
          {'  '}
          <code>Ellipsis</code> item for indicating previous or continuing
          results.
        </p>
