...
import { PopoverDirection } from 'lib/types';
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">
          Use the <code>trigger</code> attribute with value <code>focus</code>{' '}
          to dismiss popovers on the user's next click of a different element
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">
          Use the <code>trigger</code> attribute with value <code>hover</code>{' '}
          to show popover on hovering the element.
        </p>
        <OverlayTrigger
          trigger={['hover', 'focus']}
          placement="right"
