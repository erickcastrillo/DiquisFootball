    ...
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-13">
          ...
          button and an optional body class for some initial padding. We suggest
          that you include offcanvas headers with dismiss actions whenever
