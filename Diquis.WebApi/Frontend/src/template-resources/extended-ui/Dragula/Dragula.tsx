...
const MovableCard = ({ item }: { item: Color }) => {
  return (
    <Card className={clsx('mb-0', 'mt-3', 'text-white', 'bg-' + item.color)}>
      <Card.Body>
                  ...
                  <div className="bg-dragula p-2 p-lg-4">
                    ...
                    >
                      {(team1 || []).map((item, index) => {
                        return (
                          <MovableCard2 key={index.toString()} item={item} />
                        );
                      })}
                    </ReactSortable>
                  </div>
                  ...
                  <div className="bg-dragula p-2 p-lg-4">
                    ...
                    >
                      {(part1 || []).map((item, index) => {
                        return (
                          <MovableCard3 key={index.toString()} item={item} />
                        );
                      })}
                    </ReactSortable>
                  </div>
